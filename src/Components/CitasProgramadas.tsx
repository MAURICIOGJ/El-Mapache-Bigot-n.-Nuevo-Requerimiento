...
import { obtenerCitasProgramadas, crearCita, actualizarCita, eliminarCita, } from "../Services/CitasService";

const CitasProgramadas = () => { const [citas, setCitas] = useState<any[]>([]); 
const [citaSeleccionada, setCitaSeleccionada] = useState<any>({ idCliente: null, idCita: null, nombre: "", telefono: "", fecha: "", hora: "", servicio: [], precio: 0, });
